...
* Develop data match-up involving the following, as possible / available:
  * Multispectral: Landsat-8 / -9, Sentinel-2, PlanetScope
  * Hyperspectral: EMIT, PACE OCI, Tanager
  * SAR: NISAR, Sentinel-1
...
* Potential issues:
  ...
  * EMIT data are likely to be limiting also given that the data aren't regularly collected.
